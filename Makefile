# Makefile for frontend-analyzer-provider cross-compilation
#
# Usage:
...
#
# Notes:
#   - Proto generation is DISABLED during cross-compilation builds.
#     Pre-generated .rs and .bin files in crates/grpc/src/generated/ are used.
#     To regenerate protos: cargo build --features frontend-grpc/generate-proto
...
#   - gRPC/tonic native deps (aws-lc-sys, ring) are handled by zig's cross-linker

# ──────────────────────────────────────────────
# Project settings
# ──────────────────────────────────────────────
BINARY_NAME   := frontend-analyzer-provider
PACKAGE_NAME  := frontend-analyzer-provider
...
# ──────────────────────────────────────────────
# Cargo flags
# Proto generation is explicitly disabled for cross-compilation.
# Pre-generated files in crates/grpc/src/generated/ are used instead.
# ──────────────────────────────────────────────
CARGO_FLAGS := --release
...
help:
	...
	@echo "  make generate-proto       Regenerate protobuf code (host only)"
	...
	@echo ""
	@echo "Note: Proto generation is disabled during cross-compilation."
	@echo "      Pre-generated files in crates/grpc/src/generated/ are used."
...
# ──────────────────────────────────────────────
# Regenerate protobuf code (host-only, not during cross builds)
# ──────────────────────────────────────────────
generate-proto:
	cargo build --features frontend-grpc/generate-proto
...
check-deps:
	...
	@echo ""
	@echo "Proto files:"
	@printf "  generated/provider.rs:  " && (test -f crates/grpc/src/generated/provider.rs && echo "ok" || echo "MISSING — run: make generate-proto")
	@printf "  generated/descriptor:   " && (test -f crates/grpc/src/generated/provider_service_descriptor.bin && echo "ok" || echo "MISSING — run: make generate-proto")
	@echo ""
