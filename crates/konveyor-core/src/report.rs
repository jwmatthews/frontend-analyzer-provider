...
mod tests {
    ...
    #[test]
    fn test_violation_incident_with_variables() {
        let json = r#"{
            "uri": "file:///test.tsx",
            "message": "Rename prop",
            "lineNumber": 5,
        ...
        let vi: Incident = serde_json::from_str(json).unwrap();
        assert_eq!(vi.file_uri, "file:///test.tsx");
        assert_eq!(vi.message, "Rename prop");
        assert_eq!(vi.line_number, Some(5));
        assert_eq!(vi.variables.len(), 2);
    }
